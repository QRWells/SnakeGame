...
public class ChatMessageHandler extends SimpleChannelReadHandler<ChatMessage> {
  ...
  @Override
  public void read0(MessageHandlerContext ctx, ChatMessage msg) throws Throwable {
    if (msg.isGroup()) {
      var tos = ServerContext.INSTANCE.getGroups().get(msg.getReceiverId());
      ...
      var to = ServerContext.INSTANCE.getUsers().get(msg.getReceiverId());
      if (to != null) {
