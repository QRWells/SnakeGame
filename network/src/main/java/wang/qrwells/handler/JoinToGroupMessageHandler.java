...
public class JoinToGroupMessageHandler extends
    SimpleChannelReadHandler<JoinToGroupMessage> {
  private final Logger log = LoggerFactory.getLogger(
      JoinToGroupMessageHandler.class);
  ...
  @Override
  public void read0(MessageHandlerContext ctx, JoinToGroupMessage msg)
      throws Throwable {
