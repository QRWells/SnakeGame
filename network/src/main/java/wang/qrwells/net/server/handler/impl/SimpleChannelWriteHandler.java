...
public abstract class SimpleChannelWriteHandler<I> implements
    ChannelWriteHandler {
  public abstract void write0(MessageHandlerContext messageHandlerContext,
                              I msg, ByteMsg byteMsg);

  @Override
  public void write(MessageHandlerContext mhc, Object msg) throws Throwable {
    ByteMsg byteMsg = mhc.channel()
                         .eventLoop()
                         .getByteMsgAllocator()
                         .allocate(128);
